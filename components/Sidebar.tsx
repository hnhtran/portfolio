  ...
  return (
    <div>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-green md:w-full">
        ...
        <a href="https://drive.google.com/file/d/1F92iJdmTbqRIi9vZ3ZbCqoC0DTCsJ-hP/view?usp=sharing" className='flex flex-col items-center justify-between text-center'>
        Resume
          {"\n"}
